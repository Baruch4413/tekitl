    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetHeader className="sr-only">
          <SheetTitle>{t('accessibility.sidebar.title')}</SheetTitle>
          <SheetDescription>{t('accessibility.sidebar.description')}</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{t('accessibility.sidebar.toggle')}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t('accessibility.sidebar.toggle')}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t('accessibility.sidebar.toggle')}
      className={cn(
