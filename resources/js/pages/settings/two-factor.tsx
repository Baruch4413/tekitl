...
export default function TwoFactor({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <h1 className="sr-only">{t('settings.two_factor.a11y.heading')}</h1>

            <SettingsLayout>
                <div className="space-y-6">
                    <Heading
                        variant="small"
                        title={t('settings.two_factor.section.title')}
                        description={t('settings.two_factor.section.description')}
                    />
                    {twoFactorEnabled ? (
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <div>
                                {hasSetupData ? (
                                    ...
                                    >
                                        <ShieldCheck />
                                        {t('settings.two_factor.continue_setup_button')}
                                    </Button>
                                ) : (
                                    <Form
                                        {...enable.form()}
