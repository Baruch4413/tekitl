...
export default function Profile({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <h1 className="sr-only">{t('settings.profile.a11y.heading')}</h1>

            <SettingsLayout>
                <div className="space-y-6">
                    <Heading
                        variant="small"
                        title={t('settings.profile.information.title')}
                        description={t('settings.profile.information.description')}
                    />
                            ...
                            <>
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                        autoComplete="name"
                                        placeholder={t('settings.profile.fields.name_placeholder')}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t('settings.profile.fields.email_placeholder')}
                                    />
                                    ...
                                    auth.user.email_verified_at === null && (
                                        <div>
                                            <p className="-mt-4 text-sm text-muted-foreground">
                                                {t('settings.profile.verification.unverified_prefix')}{' '}
                                                <Link
                                                    href={send()}
                                                    as="button"
                                                    className="text-foreground underline decoration-neutral-300 underline-offset-4 transition-colors duration-300 ease-out hover:decoration-current! dark:decoration-neutral-500"
                                                >
                                                    {t('settings.profile.verification.resend_link')}
                                                </Link>
                                            </p>
