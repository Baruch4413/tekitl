...
const trending = [
    {
        tag: '#ios-app',
        category: 'Tecnología · Tendencia',
        count: '1.2K posts',
    },
    {
        tag: '#mobile-api',
        category: 'Desarrollo · Tendencia',
        count: '892 posts',
    },
    {
        tag: '#tailwindcss',
        category: 'Diseño · Tendencia',
        count: '2.4K posts',
    },
...
export default function Welcome({ posts }: WelcomeProps) {
    ...
    const handleEndorse = (id: number) =>
        withProcessing(id, 'endorse', endorse.url(id));

    const handleToggleLike = (id: number) =>
        withProcessing(id, 'like', toggleLike.url(id));
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            {/* Main content */}
            <div className="lg:pr-96 xl:pl-72">
                {/* Mobile top bar */}
                <div className="sticky top-0 z-40 flex h-14 items-center gap-x-4 border-b border-gray-200 bg-white/80 px-4 backdrop-blur-sm xl:hidden dark:border-white/5 dark:bg-gray-950/80">
                    ...
                    >
                        <span className="sr-only">
                            {t('projects.welcome.open_menu')}
                        </span>
                        <Bars3Icon aria-hidden className="size-5" />
                    </button>
                    <div className="flex-1 text-center">
                        <h1 className="text-base font-bold text-gray-900 dark:text-white">
                            {t('projects.welcome.home')}
                        </h1>
                    </div>
                </div>

                {/* Desktop sticky header */}
                <div className="sticky top-0 z-40 hidden border-b border-gray-200 bg-white/80 px-6 py-4 backdrop-blur-sm xl:block dark:border-white/5 dark:bg-gray-950/80">
            ...
            {/* Right sidebar */}
            <aside className="hidden overflow-y-auto border-l border-gray-200 bg-white lg:fixed lg:inset-y-0 lg:right-0 lg:flex lg:w-96 lg:flex-col dark:border-white/5 dark:bg-gray-950">
                {/* Search */}
                <div className="sticky top-0 bg-white px-4 pt-4 pb-3 dark:bg-gray-950">
                    <div className="flex items-center gap-x-3 rounded-full bg-gray-100 px-4 py-2.5 dark:bg-white/5">
                        ...
                        <input
                            type="search"
                            placeholder={t(
                                'projects.welcome.search_placeholder',
                            )}
                ...
                <div className="mx-4 mt-4 overflow-hidden rounded-2xl bg-gray-50 dark:bg-white/5">
                    <div className="border-b border-gray-200 px-4 py-3 dark:border-white/10">
                        <h2 className="text-base font-bold text-gray-900 dark:text-white">
                            {t('projects.welcome.who_to_follow')}
                        </h2>
                    </div>
                    <ul role="list">
                        {suggestions.map((person, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        {isFollowing
                                            ? t('projects.welcome.following')
                                            : t('projects.welcome.follow')}
                                    </button>
                                </li>
                            );
                        })}
